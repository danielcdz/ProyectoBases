...
<body class="text-center">
    <!-- <form class="form-signin" action="<?php echo base_url()?>LoginUsuario/validarInicio" method="POST">
    ...
    <a  class="btn btn-success"><h6>Ingresar </h6></a> 
    </form> -->
  ...
  <form   class="form-signin" action="<?php echo base_url()?>LoginUsuario/validarInicio" method="POST">
    ...
    <a   href="<?php echo base_url()?>LoginUsuario/mostrarRegistroUsuario" class="btn btn-primary"><h6>Registrarse </h6></a> 

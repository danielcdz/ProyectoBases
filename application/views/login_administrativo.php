...
<body class="text-center">
 <form   class="form-signin" action="<?php echo base_url()?>PanelAdministrativo/validarInicioSesion" method="POST">
  ...
  <hr>
  <h1 class="h3 mb-3 font-weight-normal">Panel Administrativo</h1>
